...
sudo pacman -S pacman-contrib xorg-server xorg-xinit libx11 libxcb libxft libxinerama xf86-video-fbdev ttf-droid ttf-hack ttf-dejavu neofetch ranger cmus htop adapta-gtk-theme papirus-icon-theme lxappearance nitrogen kvantum-qt5
