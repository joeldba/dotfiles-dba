...
sudo pacman -S xorg-server xorg-xinit libx11 libxcb libxft libxinerama xf86-video-fbdev ttf-droid ttf-hack neofetch ranger cmus htop arc-gtk-theme papirus-icon-theme lxappearance nitrogen kvantum-qt5
